...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['replied', 'reply', 'yourAnswer', 'send', 'threadId', 'highlight', 'isOpen'],
    methods: {
        getReplies: function getReplies() {
            var _this = this;

            window.axios.get('/replies/' + this.thread_id).then(function (response) {
                _this.replies_response = response.data;
            });
        },
        save: function save() {
            var _this2 = this;

            window.axios.post('/replies/' + this.thread_id, this.reply_to_save).then(function () {
                _this2.getReplies();
            });
        }
    },
...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm._l(_vm.replies_response.data, function(data) {
        return _c(
          "div",
          {
            ...
            _c("div", { staticClass: "card-stacked" }, [
              ...
              _vm.logged.role === "admin"
                ? _c("div", { staticClass: "card-action" }, [
                    _c(
                      "a",
                      { attrs: { href: "/replies/" + data.id + "/highlight" } },
                ...
                [
                  _c("div", { staticClass: "input-field" }, [
                    _c("textarea", {
                      ...
                      attrs: { placeholder: _vm.yourAnswer, rows: "10" },
...
var update = __webpack_require__(49)("711b4ee4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-27cb1808\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Replies.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-27cb1808\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Replies.vue");
